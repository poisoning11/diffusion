...
class CrossAttention(nn.Module):
    def __init__(self,channel,qsize,vsize,fsize,cls_emb_size):# q qsize v vsize fsize feedforward
        super().__init__()
    ...
    # 这个注意力是针对 通道来的 比如一个图像3*48*48 针对每个像素点的三通道组成的向量 例如 [1.1,2.5,3.8]
    # cross-attention 像素向量 提供q  引导词提供k,v  像素向量的q去和引导词的k打完分之后再去和v做乘法
